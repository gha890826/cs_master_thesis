...
if __name__ == '__main__':
    ...
    parser.add_argument('--eval_type', default='two')
    parser.add_argument('--root_dir', default='.')
    parser.add_argument('--img1', default='datasets/zed_tv/r/01.png')
    parser.add_argument('--img2', default='datasets/zed_tv/l/01.png')
    ...
    if args.eval_type == 'sintel':
        ...
        img_pairs = [(args.img1, args.img2)]
    print(img_pairs)
    with torch.no_grad():
        # 直接呼叫visualize_flow計算flow並且視覺化
