...
from engine import evaluate, train_one_epoch, evaluate_viz, viz
...
def main(args):
    ...
    print('num of trainable prams from pretrained model:' +
          str(n_finetune_parameters))
    ...
    if args.image and args.mhi:
        viz(model, criterion, args.image, args.mhi, device, args)
        return
    ...
    if args.eval_viz:
        test_stats, coco_evaluator = evaluate_viz(model, criterion, postprocessors,
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        'MEDUSA training and evaluation script', parents=[get_args_parser()])
